...
meta constant rewrite_core_no_tag (h : expr) (e : expr) (cfg : rewrite_cfg := {}) : tactic (expr × expr × list expr)

meta def rewrite_core (h : expr) (e : expr) (cfg : rewrite_cfg := {}) : tactic (expr × expr × list expr) :=
  solve_with_tag "rewrite" (rewrite_core_no_tag h e cfg)
